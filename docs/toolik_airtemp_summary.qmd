...
```
```{r}
toolik_chlorophyll$active_chl_a_ug_1 <-
  na_if(toolik_chlorophyll$active_chl_a_ug_l, ".")

toolik_chlorophyll$active_chl_a_ug_1 <- as.numeric(toolik_chlorophyll$active_chl_a_ug_1)
```
...
labs(title = "Toolkit chlorophyll concentrations")
